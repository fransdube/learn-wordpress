...
class DUP_PRO_Archive
{
    ...
    public function __construct(DUP_PRO_Package $package)
    {
        ...
        $indexPath          = DUPLICATOR_PRO_SSDIR_PATH_TMP . '/' . $this->Package->getIndexFileName();
        $this->indexManager = new FileIndexManager($indexPath);
    }
...
// get content array
    ...
    public function checkTreeNodesFolder($node)
    {
        ...
        if ($node->isDir) {
            ...
            if (($info = $this->indexManager->findByPath(FileIndexManager::LIST_TYPE_DIRS, $relPath)) !== null) {
