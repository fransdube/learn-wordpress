    ...
    jQuery(document).ready(function($) {
        ...
        $('#delete-backup-records').click(function() {
            ...
            Duplicator.Util.ajaxWrapper(
                {
                    action: "duplicator_pro_get_invalid_backup_records",
                    nonce: "<?php echo esc_js(wp_create_nonce('duplicator_pro_get_invalid_backup_records')); ?>"
                },
        ...
        DupPro.Pack.DeleteBackupRecords = function() {
            Duplicator.Util.ajaxWrapper(
                {
                    action: "duplicator_purge_backup_records",
                    nonce: "<?php echo esc_js(wp_create_nonce('duplicator_purge_backup_records')); ?>"
                },
                function (result, data, funcData, textStatus, jqXHR) {
