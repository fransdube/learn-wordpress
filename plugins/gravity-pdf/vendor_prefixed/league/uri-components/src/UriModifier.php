...
use GFPDF_Vendor\League\Uri\Components\DataPath;
use GFPDF_Vendor\League\Uri\Components\Domain;
use GFPDF_Vendor\League\Uri\Components\HierarchicalPath;
use GFPDF_Vendor\League\Uri\Components\Host;
use GFPDF_Vendor\League\Uri\Components\Path;
use GFPDF_Vendor\League\Uri\Components\Query;
...
use GFPDF_Vendor\Psr\Http\Message\UriInterface as Psr7UriInterface;
use function ltrim;
use function rtrim;
...
final class UriModifier
{
    ...
    {
        $query = \GFPDF_Vendor\League\Uri\Components\Query::createFromUri($uri)->append($query)->getContent();
    ...
    {
        $query = \GFPDF_Vendor\League\Uri\Components\Query::createFromUri($uri)->merge($query)->getContent();
        return $uri->withQuery(self::normalizeComponent($query, $uri));
    }
    /**
    ...
    {
        $query = \GFPDF_Vendor\League\Uri\Components\Query::createFromUri($uri)->withoutPair(...$keys)->getContent();
        return $uri->withQuery(self::normalizeComponent($query, $uri));
    }
    /**
    ...
    {
        $query = \GFPDF_Vendor\League\Uri\Components\Query::createFromUri($uri)->withoutEmptyPairs()->getContent();
        return $uri->withQuery(self::normalizeComponent($query, $uri));
    }
    /**
     * Remove query data according to their key name.
    ...
    {
        $query = \GFPDF_Vendor\League\Uri\Components\Query::createFromUri($uri)->withoutParam(...$keys)->getContent();
        return $uri->withQuery(self::normalizeComponent($query, $uri));
    }
    /**
    ...
    {
        $query = \GFPDF_Vendor\League\Uri\Components\Query::createFromUri($uri)->sort()->getContent();
        return $uri->withQuery(self::normalizeComponent($query, $uri));
    }
    /*********************************
    ...
    {
        $component = \GFPDF_Vendor\League\Uri\Components\Domain::createFromUri($uri)->withRootLabel()->getContent();
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Host::createFromUri($uri);
        $label = null === $label ? \GFPDF_Vendor\League\Uri\Components\Host::createFromNull() : \GFPDF_Vendor\League\Uri\Components\Host::createFromString($label);
        if (null === $label->getContent()) {
            return $uri;
        }
        if ($host->isDomain()) {
            $component = \GFPDF_Vendor\League\Uri\Components\Domain::createFromHost($host)->append($label)->getContent();
            return $uri->withHost(self::normalizeComponent($component, $uri));
        }
        if ($host->isIpv4()) {
            return $uri->withHost($host->getContent() . '.' . \ltrim($label->getContent(), '.'));
        }
        throw new \GFPDF_Vendor\League\Uri\Exceptions\SyntaxError(\sprintf('The URI host %s can not be appended.', $host->__toString()));
    }
    /**
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Host::createFromUri($uri)->getContent();
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Host::createFromUri($uri)->toUnicode();
        return $uri->withHost(self::normalizeComponent($host, $uri));
    }
    /**
    ...
    public static function prependLabel($uri, $label)
    {
        ...
        if ($host->isDomain()) {
            $component = \GFPDF_Vendor\League\Uri\Components\Domain::createFromHost($host)->prepend($label)->getContent();
            return $uri->withHost($component);
        }
        if ($host->isIpv4()) {
            return $uri->withHost(\rtrim($label->getContent(), '.') . '.' . $host->getContent());
        }
        throw new \GFPDF_Vendor\League\Uri\Exceptions\SyntaxError(\sprintf('The URI host %s can not be prepended.', (string) $host));
    }
    /**
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Domain::createFromUri($uri)->withoutLabel(...$keys)->getContent();
        return $uri->withHost(self::normalizeComponent($host, $uri));
    }
    /**
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Domain::createFromUri($uri)->withoutRootLabel()->getContent();
        return $uri->withHost(self::normalizeComponent($host, $uri));
    }
    /**
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Host::createFromUri($uri)->withoutZoneIdentifier()->getContent();
        return $uri->withHost(self::normalizeComponent($host, $uri));
    }
    /**
    ...
    {
        $host = \GFPDF_Vendor\League\Uri\Components\Domain::createFromUri($uri)->withLabel($offset, $label)->getContent();
        return $uri->withHost(self::normalizeComponent($host, $uri));
    }
    /*********************************
    ...
    public static function addBasePath($uri, $path)
    {
        ...
        $path = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromPath(\GFPDF_Vendor\League\Uri\Components\Path::createFromString($path))->withLeadingSlash();
        /** @var HierarchicalPath $currentPath */
        $currentPath = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withLeadingSlash();
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\Path::createFromUri($uri)->withLeadingSlash()->__toString());
    }
    /**
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\Path::createFromUri($uri)->withTrailingSlash()->__toString());
    }
    /**
    ...
    {
        return self::normalizePath($uri, \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->append($segment));
    }
    /**
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\DataPath::createFromUri($uri)->toAscii()->__toString());
    }
    /**
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\DataPath::createFromUri($uri)->toBinary()->__toString());
    }
    /**
    ...
    {
        return self::normalizePath($uri, \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->prepend($segment));
    }
    /**
    ...
    public static function removeBasePath($uri, $path)
    {
        ...
        $basePath = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromPath(new \GFPDF_Vendor\League\Uri\Components\Path($path))->withLeadingSlash();
        $currentPath = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri);
        if ('/' === (string) $basePath) {
            return $uri;
        }
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\Path::createFromUri($uri)->withoutDotSegments()->__toString());
    }
    /**
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withoutEmptySegments()->__toString());
    }
    /**
    ...
    {
        return self::normalizePath($uri, \GFPDF_Vendor\League\Uri\Components\Path::createFromUri($uri)->withoutLeadingSlash());
    }
    /**
    ...
    {
        return $uri->withPath(\GFPDF_Vendor\League\Uri\Components\Path::createFromUri($uri)->withoutTrailingSlash()->__toString());
    }
    /**
    ...
    {
        $path = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withoutSegment(...$keys)->__toString();
    ...
    {
        $path = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withBasename($basename)->__toString();
        return $uri->withPath($path);
    }
    /**
    ...
    {
        $path = \GFPDF_Vendor\League\Uri\Components\DataPath::createFromUri($uri)->withParameters($parameters)->__toString();
        return $uri->withPath($path);
    }
    /**
    ...
    {
        $path = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withDirname($dirname)->__toString();
        return $uri->withPath($path);
    }
    /**
    ...
    {
        $path = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withExtension($extension)->__toString();
        return $uri->withPath($path);
    }
    /**
    ...
    {
        $path = \GFPDF_Vendor\League\Uri\Components\HierarchicalPath::createFromUri($uri)->withSegment($offset, $segment)->__toString();
        return $uri->withPath($path);
    }
    /**
     ...
     * @return Psr7UriInterface|UriInterface
     */
    private static function normalizePath($uri, \GFPDF_Vendor\League\Uri\Contracts\PathInterface $path)
    {
