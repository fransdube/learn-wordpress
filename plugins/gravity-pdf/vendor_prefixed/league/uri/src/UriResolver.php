...
final class UriResolver
{
    ...
    public static function resolve($uri, $base_uri)
    {
        ...
        $null = $uri instanceof \GFPDF_Vendor\Psr\Http\Message\UriInterface ? '' : null;
    ...
    {
        if (!$uri instanceof \GFPDF_Vendor\League\Uri\Contracts\UriInterface && !$uri instanceof \GFPDF_Vendor\Psr\Http\Message\UriInterface) {
    ...
    private static function removeDotSegments(string $path) : string
    {
        ...
        $new_path = \implode('/', \array_reduce($old_segments, [\GFPDF_Vendor\League\Uri\UriResolver::class, 'reducer'], []));
    ...
    private static function resolvePathAndQuery($uri, $base_uri) : array
    {
        ...
        $null = $uri instanceof \GFPDF_Vendor\Psr\Http\Message\UriInterface ? '' : null;
        $baseNull = $base_uri instanceof \GFPDF_Vendor\Psr\Http\Message\UriInterface ? '' : null;
    ...
    private static function getComponent(string $method, $uri) : ?string
    {
        ...
        if ($uri instanceof \GFPDF_Vendor\Psr\Http\Message\UriInterface && '' === $component) {
            return null;
        }
        return $component;
    }
    ...
    private static function formatHost($uri)
    {
        ...
        return $uri->withHost((string) \GFPDF_Vendor\League\Uri\Uri::createFromComponents(['host' => $host])->getHost());
    }
    /**
    ...
    {
        return !\GFPDF_Vendor\League\Uri\UriInfo::isRelativePath($uri) && self::componentEquals('getScheme', $uri, $base_uri) && self::componentEquals('getAuthority', $uri, $base_uri);
    }
    /**
